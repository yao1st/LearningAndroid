package com.example.yao.listviewtest;
...
//    }
    ...
    private void initFruits(){
        for (int i=0;i<2;i++){
            ...
            fruitList.add(grape);
            Fruit pineapple = new Fruit("Pineapple",R.drawable.orange_pic);
            fruitList.add(pineapple);
            Fruit strawberry = new Fruit("Strawberry", R.drawable.watermelon_pic);
            fruitList.add(strawberry);
            Fruit cherry = new Fruit("Cherry",R.drawable.orange_pic);
